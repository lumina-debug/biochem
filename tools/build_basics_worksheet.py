...
<meta name="description" content="生化学の基礎事項を高校生物からの橋渡しとして穴埋め形式でまとめた B5 印刷用シート。問題面と解答面つき。" />
<link rel="stylesheet" href="print.css" />
</head>
<body>

<div class="screen-only">
  🖨️ <b>この資料は B5 印刷用です。</b>ブラウザの印刷（Ctrl/⌘+P）→ 用紙 <b>JIS B5</b>・余白「既定」・<b>「背景のグラフィック」をON</b>。
